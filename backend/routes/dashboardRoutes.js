...
router.get("/dashboard", authMiddleware, async (req, res) => {
  try {
    ...
    const { totalDuplicateFiles, wastedBytes } =
      await calculateDuplicateWaste(req.user.id);
    ...
    // Note: activity_logs has no userId column in the current schema,
    // so this is the full site-wide log, not scoped to this user.
